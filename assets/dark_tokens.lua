return function(p)
	return {
		...
		FontSize = {
			FontSize_200 = 10.08 * p,
			FontSize_250 = 12.6 * p,
			FontSize_300 = 15.12 * p,
			FontSize_350 = 17.64 * p,
			FontSize_400 = 20.16 * p,
			FontSize_500 = 25.2 * p,
			FontSize_600 = 30.24 * p,
			FontSize_700 = 35.28 * p,
			FontSize_800 = 40.32 * p,
			FontSize_900 = 45.36 * p,
			FontSize_1000 = 50.4 * p,
			FontSize_1100 = 55.44 * p,
			FontSize_1200 = 60.48 * p,
			FontSize_1300 = 65.52 * p,
			FontSize_1400 = 70.56 * p,
			FontSize_1500 = 75.6 * p,
			FontSize_1600 = 80.64 * p,
			FontSize_1700 = 85.68 * p,
			FontSize_1800 = 90.72 * p,
			FontSize_1900 = 95.76 * p,
			FontSize_2000 = 100.8 * p,
			FontSize_2100 = 105.84 * p,
			FontSize_2200 = 110.88 * p,
			FontSize_2300 = 115.92 * p,
			FontSize_2400 = 120.96 * p,
			FontSize_2500 = 126 * p,
			FontSize_2600 = 131.04 * p,
			FontSize_2700 = 136.08 * p,
			FontSize_2800 = 141.12 * p,
			FontSize_2900 = 146.16 * p,
			FontSize_3000 = 151.2 * p
		},
		FontWeight = {
